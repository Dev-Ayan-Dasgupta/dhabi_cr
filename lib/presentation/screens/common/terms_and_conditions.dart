...
class TermsAndConsitionsScreen extends StatefulWidget {
  const TermsAndConsitionsScreen({Key? key}) : super(key: key);

  @override
  State<TermsAndConsitionsScreen> createState() =>
      _TermsAndConsitionsScreenState();
}

class _TermsAndConsitionsScreenState extends State<TermsAndConsitionsScreen> {
